...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const friendsCelebList_src = [
        ...
        { src: "https://res.cloudinary.com/drdrs6pdq/image/upload/v1714608753/Niko/f_f_14_dulpgp.webp", caption: 'Jose Andres'},
        { src: "https://res.cloudinary.com/drdrs6pdq/image/upload/v1714611082/Niko/f_f_16_i861kj.webp", caption: 'Tony Priolo'},
        { src: "https://res.cloudinary.com/drdrs6pdq/image/upload/v1714611418/Niko/f_f_19_cygdn0.webp", caption: 'Sarah Grueneberg'},
        { src: "https://res.cloudinary.com/drdrs6pdq/image/upload/v1714612983/Niko/f_f_32_jvdutb.webp", caption: 'Fabio Viviani'},
        { src: "https://res.cloudinary.com/drdrs6pdq/image/upload/v1714607529/Niko/f_f_11_metou3.webp", caption: 'Sanaa Abourezk'},
        { src: "https://res.cloudinary.com/drdrs6pdq/image/upload/v1714607192/Niko/f_f_9_zacdoe.webp", caption: 'Brother Luck'},
        { src: "https://res.cloudinary.com/drdrs6pdq/image/upload/q_80,w_800,h_1200,c_fill/v1714603600/Niko/f_f_3_ypggwg.webp", caption: 'Izzy Arroyo & Kostas Chaidaropoulos'},
        { src: "https://res.cloudinary.com/drdrs6pdq/image/upload/q_80,w_800,h_1200,c_fill/v1714604103/Niko/f_f_4_tu7gvz.webp", caption: 'Jose Andres'},
        { src: "https://res.cloudinary.com/drdrs6pdq/image/upload/q_80,w_800,c_fill/v1714604694/Niko/f_f_5_pti2yn.webp", caption: 'Sarah Stegner'},
        { src: "https://res.cloudinary.com/drdrs6pdq/image/upload/v1714607390/Niko/f_f_10_y0mfzb.webp", caption: 'Paul Kahan'},
        { src: "https://res.cloudinary.com/drdrs6pdq/image/upload/v1714611192/Niko/f_f_17_dhcths.webp", caption: 'Anthony Martorina'},
        { src: "https://res.cloudinary.com/drdrs6pdq/image/upload/v1714611927/Niko/f_f_24_bl55y4.webp", caption: 'Logan Sandoval & Michelle Garcia'},
        { src: "https://res.cloudinary.com/drdrs6pdq/image/upload/v1714613141/Niko/f_f_34_zcya8h.webp", caption: 'Darnell Reed'},
        { src: "https://res.cloudinary.com/drdrs6pdq/image/upload/v1714613623/Niko/f_f_37_pxhi3p.webp", caption: 'Casey Nicole Doody'},
        { src: "https://res.cloudinary.com/drdrs6pdq/image/upload/v1715041545/viber_image_2024-05-06_19-19-15-109_gco6hq.webp", caption: "D'Andre Carter"},
        { src: "https://res.cloudinary.com/drdrs6pdq/image/upload/v1715041545/viber_image_2024-05-06_19-19-34-967_shgs66.webp", caption: 'Soo Kyo Ahn'},
        { src: "https://res.cloudinary.com/drdrs6pdq/image/upload/v1715044783/viber_image_2024-05-06_20-09-18-396_erkru4.webp", caption: 'Robert Lang & Quince'},
        { src: "https://res.cloudinary.com/drdrs6pdq/image/upload/v1715044784/viber_image_2024-05-06_20-12-45-373_xckkgu.webp", caption: 'John Boudouvas'},
        { src: "https://res.cloudinary.com/drdrs6pdq/image/upload/v1714613295/Niko/f_f_35_zgjzm4.webp", caption: 'Tim Allen'},
        { src: "https://res.cloudinary.com/drdrs6pdq/image/upload/v1714611315/Niko/f_f_18_nwuxra.webp", caption: 'Kendall Jenner'},
        { src: "https://res.cloudinary.com/drdrs6pdq/image/upload/v1715041546/viber_image_2024-05-06_09-14-52-204_kcwld6.webp", caption: 'Michelle Mekky'},
        { src: "https://res.cloudinary.com/drdrs6pdq/image/upload/v1715041545/viber_image_2024-05-06_19-23-35-469_u0xdb4.webp", caption: 'Dj Tiesto'},
        { src: "https://res.cloudinary.com/drdrs6pdq/image/upload/v1715041545/viber_image_2024-05-06_18-16-04-970_nxefty.webp", caption: 'Phil Vettel & Eleftheria Sioulas'},
        { src: "https://res.cloudinary.com/drdrs6pdq/image/upload/v1715041545/viber_image_2024-05-06_19-22-41-400_kjycqo.webp", caption: 'Makropoulos & Stan'},
        { src: "https://res.cloudinary.com/drdrs6pdq/image/upload/q_80,w_800,h_1200,c_fill/v1714601356/Niko/f_f_2_bpez7h.webp", caption: 'Tamron Hall'},
        { src: "https://res.cloudinary.com/drdrs6pdq/image/upload/v1714696956/20231222_160947_lzbtfg.webp", caption: null},
        { src: "https://res.cloudinary.com/drdrs6pdq/image/upload/q_80,w_800,h_1200,c_fill/v1714605010/Niko/f_f_6_lapp0q.webp", caption: 'Roquan Smith'},
        { src: "https://res.cloudinary.com/drdrs6pdq/image/upload/v1714605777/Niko/f_f_7_f2s8zh.webp", caption: 'Andre Drummond'},
        { src: "https://res.cloudinary.com/drdrs6pdq/image/upload/v1714606635/Niko/f_f_8_lbql67.webp", caption: 'Cole Kmet & Lou Canellis'},
        { src: "https://res.cloudinary.com/drdrs6pdq/image/upload/v1714607629/Niko/f_f_12_lw4pkp.webp", caption: 'Candace Collins'},
        { src: "https://res.cloudinary.com/drdrs6pdq/image/upload/v1714607919/Niko/f_f_13_njsqqk.webp", caption: 'Tsotras H & Kyrkos A'},
        { src: "https://res.cloudinary.com/drdrs6pdq/image/upload/v1714610871/Niko/f_f_15_syo3bh.webp", caption: 'Justin Fields'},
        { src: "https://res.cloudinary.com/drdrs6pdq/image/upload/v1714611504/Niko/f_f_20_yxq3gm.webp", caption: 'Matt Eberflus'},
        { src: "https://res.cloudinary.com/drdrs6pdq/image/upload/v1714611614/Niko/f_f_21_n0jrv2.webp", caption: 'Nick Galis '},
        { src: "https://res.cloudinary.com/drdrs6pdq/image/upload/v1714611684/Niko/f_f_22_agudmu.webp", caption: 'Nick Galis'},
        { src: "https://res.cloudinary.com/drdrs6pdq/image/upload/v1714611853/Niko/f_f_23_zgxxng.webp", caption: 'Dimitris Basis'},
        { src: "https://res.cloudinary.com/drdrs6pdq/image/upload/v1714612087/Niko/f_f_25_oai4zu.webp", caption: null},
        { src: "https://res.cloudinary.com/drdrs6pdq/image/upload/v1714612235/Niko/f_f_26_oi8rbi.webp", caption: 'Basis D & Protopsalti A.'},
        { src: "https://res.cloudinary.com/drdrs6pdq/image/upload/v1714612584/Niko/f_f_28_uvsrep.webp", caption: 'Dina Bair'},
        { src: "https://res.cloudinary.com/drdrs6pdq/image/upload/v1714612645/Niko/f_f_29_rznm8c.webp", caption: 'Dawn Hashbrouk'},
        { src: "https://res.cloudinary.com/drdrs6pdq/image/upload/v1714612758/Niko/f_f_30_le2dkm.webp", caption: 'Evrod Cassimy & Matthew Rodriguez '},
        { src: "https://res.cloudinary.com/drdrs6pdq/image/upload/v1714612846/Niko/f_f_31_hetsw8.webp", caption: 'Linda Bacin'},
        { src: "https://res.cloudinary.com/drdrs6pdq/image/upload/v1714613151/Niko/f_f_33_ke48sd.webp", caption: 'Kevin Warren'},
        { src: "https://res.cloudinary.com/drdrs6pdq/image/upload/v1714613366/Niko/f_f_36_j484sl.webp", caption: 'Lisa Fielding'},
        { src: "https://res.cloudinary.com/drdrs6pdq/image/upload/v1714613639/Niko/f_f_38_mfwtlr.webp", caption: 'Amy Rutledge & Tonya Francisco'},
        { src: "https://res.cloudinary.com/drdrs6pdq/image/upload/v1715304167/viber_image_2024-05-07_22-30-12-805_kndjk7.webp", caption: 'Gianluigi Buff'},
    ]
